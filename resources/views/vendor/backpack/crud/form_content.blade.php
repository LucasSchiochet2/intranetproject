            ...
            $.each(errorMessages, function (inputName, messages) {
              ...
              $.each(messages, function(key, msg){
                  ...
                  @if ($crud->tabsEnabled())
                    ...
                    try {
                      $('#form_tabs[data-form-id="' + (typeof currentFormId !== 'undefined' ? currentFormId : '{{ $formId ?? $id ?? 'crudForm' }}') + '"] [aria-controls="'+tab_id+'"]').addClass('text-danger');
                    } catch (e) {
                    ...
                    if (firstErrorField !== null) {
                      ...
                      if (firstErrorTab) {
                        try {
                            var selector = '#form_tabs[data-form-id="' + (typeof currentFormId !== 'undefined' ? currentFormId : '{{ $formId ?? $id ?? 'crudForm' }}') + '"] .nav a[href="#' + firstErrorTab + '"]';
                            $(selector).tab('show');
                        } catch (e) {
