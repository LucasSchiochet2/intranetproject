...
class MessageCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('title')->label('Título')->maxLength(255)->required(true);
        CRUD::field('content')->label('Conteúdo')->type('textarea');
        CRUD::field('collaborators')->label('Colaboradores')->type('checklist')
            ->label('Colaboradores')
